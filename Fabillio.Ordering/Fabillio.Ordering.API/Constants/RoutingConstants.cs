namespace Fabillio.Inventory.API.Constants;

internal static class RoutingConstants
{
    internal static class Documentation
    {
        internal const string _baseApiName = "Fabillio.Inventory.Api";
        internal const string _technicalApiName = "Fabillio.Inventory.Api.Technical";
